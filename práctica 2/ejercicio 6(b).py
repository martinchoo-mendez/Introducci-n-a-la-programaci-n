...
#pantalla al menor de ambos. Luego hacer 3 corridas de escritorio, luego pasarlo a
...
if n1<n2:
    print("entre estos dos números, el menor es: ", n1)
else:
    print("entre estos dos números, el menor es: ", n2)